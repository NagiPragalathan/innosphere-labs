        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <span className="font-medium text-xs text-cyan-400">COOKIES & TRACKING</span>
            </motion.div>
          ...
          >
            ...
            <section className="bg-gray-900/50 rounded-lg p-6 backdrop-blur-sm border border-gray-800">
              ...
              <p className="leading-relaxed">
                This Cookie Policy explains how InnoSphere Labs uses cookies and similar technologies on our website and platforms.
              </p>
            </section>
            ...
            <section className="bg-gray-900/50 rounded-lg p-6 backdrop-blur-sm border border-gray-800">
              ...
              <p className="leading-relaxed">
                Cookies are small text files placed on your device to collect and store information about your website interactions.
              </p>
            </section>
            ...
            <section className="bg-gray-900/50 rounded-lg p-6 backdrop-blur-sm border border-gray-800">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Analytical cookies to analyze website usage and improve user experience</li>
                <li>Marketing cookies for tailored advertising and promotions</li>
              </ul>
            </section>

            {/* Types of Cookies */}
            <section className="bg-gray-900/50 rounded-lg p-6 backdrop-blur-sm border border-gray-800">
              <h2 className="text-xl font-semibold text-white mb-4">Types of Cookies</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-cyan-400 mb-2">Session Cookies</h3>
                  <p>Temporary and deleted after each session</p>
                </div>
                <div>
                  <h3 className="text-lg font-medium text-purple-400 mb-2">Persistent Cookies</h3>
                  <p>Remain on your device until deleted or expired</p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-gray-900/50 rounded-lg p-6 backdrop-blur-sm border border-gray-800">
              ...
              <p className="leading-relaxed">
                You may control cookie preferences via your browser settings. Note that restricting cookies may impact website functionality.
              </p>
            </section>

            {/* Updates to Policies */}
            <section className="bg-gray-900/50 rounded-lg p-6 backdrop-blur-sm border border-gray-800">
              <h2 className="text-xl font-semibold text-white mb-4">Updates to Policies</h2>
              <p className="leading-relaxed">
                InnoSphere Labs reserves the right to update these policies periodically. Users will be notified of significant changes via email or prominently on our website.
              </p>
            </section>
            ...
            <section className="bg-gray-900/50 rounded-lg p-6 backdrop-blur-sm border border-gray-800">
              ...
              <p className="leading-relaxed mb-4">For questions regarding these policies:</p>
              <div className="space-y-2">
                <p>InnoSphere Labs</p>
                <p>Guindy Industrial Estate, Chennai 600032, India</p>
                <p>Email: <a href="mailto:contact@innospherelabs.com" className="text-cyan-400 hover:text-cyan-300">contact@innospherelabs.com</a></p>
                <p>Phone: +91 989463 9463</p>
              </div>
            </section>
          </motion.div>
        </div>
