...
const ServicesSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Accelerate your innovation journey with rapid prototyping, MVP development, and continuous innovation labs. Our agile model helps you test emerging technologies—like Generative AI, IoT, and Blockchain—before full-scale implementation.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
